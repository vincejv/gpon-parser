...
func (o ZTEF670L) GetGponUrl() string {
	protocol := getenv("ONT_WEB_PROTOCOL", "http")
...
func (o ZTEF670L) GetWebUsern() string {
	return getenv("ONT_WEB_USER", "admin")
}

func (o ZTEF670L) GetWebPassw() string {
	return getenv("ONT_WEB_PASS", "admin")
}

func (o ZTEF670L) GetModemIp() string {
	return getenv("ONT_WEB_HOST", "192.168.1.1")
}

func (o ZTEF670L) GetTelnetPort() string {
	return getenv("ONT_TELNET_PORT", "23")
}

func (o ZTEF670L) GetWebUiPort() string {
	return getenv("ONT_WEB_PORT", "80")
}
...
func (o ZTEF670L) UpdateCachedPage() {
	...
	randNo := fmt.Sprintf("%d", randInt(10000000, 89999999))
...
func (o ZTEF670L) parsePage(client http.Client, url string, docPage *DocPage) {
...
func (o ZTEF670L) GetStatsFromTelnet() (deviceInfo *DeviceStats) {
	...
	err = performTelnetLogin(conn, telnetUsern, telnetPassw)
	if err != nil {
...
func (o ZTEF670L) GetOpticalInfo() *OpticalStats {
	...
	if cachedPage.GetPage() != nil {
		...
		txPower := strings.Split(strings.Split(cachedPage.docStr, `var TxPower = "`)[1], `";`)[0]
...
func (o ZTEF670L) GetDeviceInfo() *DeviceStats {
...
func (o ZTEF670L) CheckLoginAuth(cb cipher.Block, user string, pass string) []byte {
	var rawBody = pad([]byte(`CheckLoginAuth.gch?version50&user=`+user+`&pass=`+pass), 16)
	var reqBody = encryptAesEcb(rawBody, cb)
	...
	if resp.StatusCode == 200 {
		...
		var cipherTextDecrypted = decryptAesEcb(cipherText, cb)
		return unpad(cipherTextDecrypted, 16)
	} else {
...
func (o ZTEF670L) OpenTelnet(cb cipher.Block) []byte {
	...
	var rawBody = pad([]byte(`FactoryMode.gch?mode=2&user=notused`), 16)
	var reqBody = encryptAesEcb(rawBody, cb)
	var url = fmt.Sprintf("%s/webFacEntry", o.GetGponUrl())
